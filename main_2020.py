...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='/mnt/DATA_OTHER/paip2020/patches/level2_400/')
    parser.add_argument('--train_path', type=str, default='/mnt/DATA_OTHER/paip2020/patches/level1_400/train/')
    parser.add_argument('--train_anno_path', type=str, default=None)
    parser.add_argument('--valid_path', type=str, default='/mnt/DATA_OTHER/paip2020/patches/level1_400/validation/')
